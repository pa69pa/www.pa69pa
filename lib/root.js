...
console.log('START',dt.params.get("gallery"),'document.referrer=',document.referrer);
...
function fetchFiles(){////// REFERERssss !!!!!!!!!!!!!!!!
    console.log('fetchFiles');
    fetch('https://content.googleapis.com/drive/v3/files?q=%270B2ewWn6gxlugTTZrMzZiRTkzNTQ%27%20in%20parents&key=AIzaSyDmwXJHYCpCIpMLObplGJexDCpwEVEKzJ8'
    ,{method:'GET',referrer:'https://pa69pa.github.io/www.pa69pa/index.html',referrerPolicy:'no-referrer-when-downgrade'})
    .then(r=>{console.log('Fr=',r);if(r.ok)return r.json()})
    .then(f=>{console.log('Fs=',f);})
